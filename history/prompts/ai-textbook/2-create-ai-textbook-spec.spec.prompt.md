...
command: /sp.specify
labels: [specification, ai-textbook, robotics, docusaurus]
links:
...
You are a Senior Systems Architect and AI Platform Engineer.

Your task is to generate a full TECHNICAL SPECIFICATION for an AI-native
textbook platform titled:

"Physical AI & Humanoid Robotics — An AI-Native Textbook for Embodied Intelligence"

Context:
- The textbook is built using Docusaurus.
- It is deployed via GitHub and Vercel.
- It embeds an AI-powered RAG chatbot using OpenAI Agents / ChatKit SDKs.
- Backend services use FastAPI.
- Vector storage uses Qdrant Cloud (free tier).
- Metadata and user state use Neon Serverless Postgres.
- The platform supports personalization, authentication, and translation.
- Users may ask questions about the full book OR only selected text.
...
Instructions:
1. Write a precise, implementation-ready technical specification.
2. Do NOT include marketing language.
3. Do NOT include constitution or philosophy.
4. Assume this document will guide real development.
5. Be explicit about system boundaries and data flow.

The specification MUST include the following sections (use markdown headings):

1. System Overview
2. User Roles & Capabilities
3. Book Structure Specification
4. AI & Agent Architecture
5. RAG Chatbot Specification
6. Personalization & Translation Features
...
- Clearly explain how "selected-text-only Q&A" works.
- Clearly define AI grounding and hallucination prevention.
- Mention how AI agents interact with book content.
- Keep the language formal and engineering-focused.
...
- ✅ Impact: Created comprehensive technical specification for AI-native textbook platform
- 🧪 Tests: none
- 📁 Files: Created specs/1-ai-textbook/spec.md and specs/1-ai-textbook/checklists/requirements.md
- 🔁 Next prompts: Plan implementation of AI-native textbook platform
- 🧠 Reflection: Specification covers all required sections with detailed technical requirements for the AI-native textbook platform
